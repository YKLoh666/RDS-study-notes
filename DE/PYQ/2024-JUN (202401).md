...
- Anonymisation
  - Encode the sensitive fields such as customer name and email address using a one-way hash function to protect customer privacy. This allows the privacy of customers to be maintained while still allowing for analysis of review data.
