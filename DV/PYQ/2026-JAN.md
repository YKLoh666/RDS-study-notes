...
- [2026 January Exam](#2026-january-exam)
...
- **Pie chart**: Hard to compare relative sizes of slices, especially when there are many categories or similar proportions.
- **Stacked bar chart**: Hard to compare relative sizes of segments, as they are stacked on top of each other and not shared a common baseline.
- **Grouped bar chart**: Easily compare relative sizes of bars within the same group, as they share a common baseline, making it easier to see differences between categories.
